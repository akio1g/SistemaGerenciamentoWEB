...
EXEC sp_listar_produto -- Listar todos os produtos
EXEC sp_lista_produto_por_nome --x (x = nome_produto) Usada para listar os produtos por nome
...
EXEC sp_pesquisar_Usuario_Por_Id 1--X Usada para pesquisar pro id